...
description: 'Train custom AQI prediction models using various machine learning algorithms'
---

## Overview

This guide covers training AQI prediction models using different machine learning approaches, from traditional algorithms to deep learning models. You'll learn how to configure training pipelines, optimize hyperparameters, and save trained models for deployment.
